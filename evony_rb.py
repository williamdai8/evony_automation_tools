...
def collect_new_monsters_from_AC():
    ...
    bosses_names = boss_list['boss_name'].tolist()
    priorities = boss_list['priorities'].tolist()
    hit = boss_list['hit'].tolist()
    boss_level = boss_list['boss_level'].tolist()
    type = boss_list['type'].tolist()
                ...
                if re.search("^.+K:.+X:.+", line):
                    ...
                    if(boss_exists == 'Alive' and alliance_war == '1'):
                        ...
                        if(boss_name in bosses_names):
                            if(distance <= 450):
                                priority = priorities[bosses_names.index(boss_name)]
